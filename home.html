...
<!-- encabezado -->
  <header class="jumbotron-fluid bg-primary">
    <nav>
      ...
      <a class="nav-link" href="amigos.html"><ion-icon name="contacts"></ion-icon>Amigos</a>
...
<!-- Cuerpo -->
  ...
  <footer class="jumbotron-fluid bg-primary">
    <nav class="nav justify-content-center my-3">
      <a class="nav-link" href="faq.html"><ion-icon name="help"></ion-icon>Preguntas Frecuentes</a>
