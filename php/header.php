<header style="background-color:#6f42c1;" class="jumbotron-fluid">
    <nav>
      <img style=margin-right:20px class="logo float-right" src="img/logo.png" alt="logo">
      <button  class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
     <span class="navbar-toggler-icon"><i class="fas fa-bars"></i></span>
   </button>
        <div style="margin-left:5px;" class="collapse navbar-collapse" id="navbarTogglerDemo01">
